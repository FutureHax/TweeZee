...
public class LogActivity extends SherlockFragmentActivity {
	...
	int place;
	int p;
	String options[] = new String[] {"Twitter", "SMS", "Email", "Facebook"};
		...
		public boolean onOptionsItemSelected(MenuItem item) {
			if (item.getItemId() == android.R.id.home) {
	            ...
	            return true;
	      		...
	      		builder.setMessage("This will delete all of your logs. Are you sure you want to continue?")
	      		   .setCancelable(false)
	      		   .setPositiveButton("For sure dude.", new DialogInterface.OnClickListener() {
	      		       public void onClick(DialogInterface dialog, int id) {
	      					File og = new File(Environment.getExternalStorageDirectory()+"/t3hh4xx0r/ultimate_scheduler/log.txt");
	      					og.delete();
	      		 		}
	      		   })
