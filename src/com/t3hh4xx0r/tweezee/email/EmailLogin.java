	...
	public void onCreate(Bundle icicle) {
		...
		loginB.setOnClickListener(new OnClickListener() {
			...
			public void onClick(final View v) {
				final String encryptedUser = Encryption.encryptString(userET
						.getText().toString(), Encryption.KEY);
				final String encryptedPass = Encryption.encryptString(passET
						.getText().toString(), Encryption.KEY);
				...
				builder.setMessage(
						"Please be sure your user/pass combo are correct. No authentication checks will be made until messages are sent.\n\n"
						...
						.setCancelable(false)
						.setPositiveButton("Ok, I\'m cool with that.",
